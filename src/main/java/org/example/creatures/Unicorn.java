 ...
 */
public class Unicorn extends Creature implements Run, Viviparous {
     ...
     */
    public Unicorn(String name, String gender, int weight, int height, int age, int health, String cries) {
